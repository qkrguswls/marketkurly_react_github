...
export default function Sub05SignUpComponent({회원가입}) {
    ...
    const onClickDuplCheck=(e, value)=>{
        ...
        if (value === 'ID중복확인') {
            ...
            axios({
                    url: 'https://qkrguswls309.com/week8_kurly/id_duplicate_check.php',
                    method: 'POST',
                    data: newFormData
            })
            .then((res)=>{
            ...
            axios({
                    url: 'https://qkrguswls309.com/week8_kurly/email_duplicate_check.php',
                    method: 'POST',
                    data: newFormData
            })
            .then((res)=>{
    ...
    const onSubmitSignup=(e)=>{
        ...
        if (아이디 === '') {
            ...
            axios({
                url: 'https://qkrguswls309.com/week8_kurly/signup.php',
                method: 'POST',
                data: newFormData
            })
            .then((res)=>{
